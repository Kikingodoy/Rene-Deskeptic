...
Where $\mathcal{L}_{task}$ represents the standard outcome loss, $R_{ep}(t)$ introduces the epistemic penalty for hallucinated causal links, and $\mathcal{L}_{con}(G_{t})$ ensures the internal consistency of the causal graph itself.
